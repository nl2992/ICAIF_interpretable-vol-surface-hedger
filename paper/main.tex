...
such an architecture is feasible.  Three aspects its scope leaves open motivate our
extension: (1)~\emph{state}: ProtoHedge keys on spot price, delta, and time-to-maturity;
